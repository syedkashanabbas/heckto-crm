<template x-teleport="#x-teleport-target">
  ...
  <span
    class="pointer-events-none absolute right-3 top-8 text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent"
  >
    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
    </svg>
  ...
  <small class="mt-1 text-xs text-slate-400 dark:text-navy-300">
    Leave empty if this project has no deadline
  </small>
</label>
