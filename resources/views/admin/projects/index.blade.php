            ...
            >
              <div>
                <div class="flex items-start justify-between">
                  <img
                    class="size-12 rounded-lg object-cover object-center"
                   src="{{ asset('assets/images/others/design-sm.jpg') }}"
                    alt="image"
                  />
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-info px-2 text-xs-plus text-white"
                  >
                    2 week left
                  </div>
                  <div>
          ...
          <div class="card shadow-none">
            ...
            >
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-secondary px-2 text-xs-plus text-white"
                  >
                    6 week left
                  </div>
                  <div>
          ...
          <div class="card shadow-none">
            ...
            >
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-success px-2 text-xs-plus text-white"
                  >
                    3 week left
                  </div>
                  <div>
          ...
          <div class="card shadow-none">
            ...
            >
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-error px-2 text-xs-plus text-white"
                  >
                    1 week left
                  </div>
                  <div>
            ...
            >
              ...
              <div>
                <div class="mt-4">
                  ...
                  <p
                    class="text-right text-xs-plus font-medium text-primary dark:text-accent-light"
                  >
                    52%
                  </p>
                </div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-primary px-2 text-xs-plus text-white dark:bg-accent"
                  >
                    3 week left
                  </div>
                  <div>
          ...
          <div class="card shadow-none">
            ...
            >
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  <div
                    class="badge h-5.5 rounded-full bg-warning px-2 text-xs-plus text-white"
                  >
                    2 week left
                  </div>
                  <div>
