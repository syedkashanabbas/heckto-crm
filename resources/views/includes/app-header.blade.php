        ...
        >
          ...
          <div class="flex items-center justify-between w-full">
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
                ...
                >
                  <div class="relative flex h-8 mr-4">
                    <input
                      ...
                      class="h-full px-4 rounded-full form-input peer bg-slate-150 pl-9 text-xs-plus text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring-3 dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        class="flex px-2 overflow-x-auto rounded-t-lg is-scrollbar-hidden shrink-0 bg-slate-100 text-slate-600 dark:bg-navy-800 dark:text-navy-200"
                      >
                        <button
                      ...
                      <div
                        class="pb-2 overflow-y-auto is-scrollbar-hidden overscroll-contain"
                      >
                        <div
                          class="flex px-3 mt-3 space-x-4 overflow-x-auto is-scrollbar-hidden"
                        >
                          <a href="apps-kanban.html" class="text-center w-14">
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-success"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                          ...
                          >
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-secondary"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                          ...
                          <a href="apps-chat.html" class="text-center w-14">
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-info"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                          ...
                          >
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-error"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                          ...
                          >
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-primary dark:bg-accent"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                          ...
                          <a href="apps-todo.html" class="text-center w-14">
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-info"
                              >
                          ...
                          >
                            <div class="avatar size-12">
                              <div
                                class="text-white rounded-full is-initial bg-warning"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="size-5"
                        ...
                        >
                          ...
                          <a
                            ...
                            class="font-medium uppercase transition-colors duration-300 text-tiny-plus text-primary outline-hidden hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70"
                          >
                            View All
                          </a>
                        </div>

                        <div class="mt-1 font-medium font-inter">
                          <a
              ...
              >
                <i
                  class="text-lg font-semibold text-transparent fa-solid fa-palette bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text"
                ></i>
              </button>
              ...
              >
                ...
                >
                  ...
                  <span
                    class="absolute flex items-center justify-center -top-px -right-px size-3"
                  >
                    <span
                      class="absolute inline-flex w-full h-full rounded-full animate-ping bg-secondary opacity-80"
                    ></span>
                    <span
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        class="flex px-3 overflow-x-auto is-scrollbar-hidden shrink-0"
                      >
                        <button
                          @click="activeTab = 'tabAll'"
                          :class="activeTab === 'tabAll' ? 'border-primary dark:border-accent text-primary dark:text-accent-light' : 'border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100'"
                    ...
                    <div class="flex flex-col overflow-hidden tab-content">
                      ...
                      >
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-secondary/10 dark:bg-secondary-light/15"
                          >
                            <i
                        ...
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-info/10 dark:bg-info/15"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div>
                            ...
                            <div
                              class="flex mt-1 text-xs text-slate-400 dark:text-navy-300"
                            >
                        ...
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-primary/10 dark:bg-accent-light/15"
                          >
                            <i
                        ...
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-success/10 dark:bg-success/15"
                          >
                        ...
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-warning/10 dark:bg-warning/15"
                          >
                        ...
                        <div class="flex items-center space-x-3">
                          <div
                            class="flex items-center justify-center rounded-lg size-10 shrink-0 bg-error/10 dark:bg-error/15"
                          >
