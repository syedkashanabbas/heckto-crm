 <div
      ...
      >
        <div
          class="flex items-center px-3 pt-2 space-x-2 bg-slate-100 dark:bg-navy-800"
        >
          <button
        ...
        <div
          ...
          class="flex px-2 overflow-x-auto is-scrollbar-hidden shrink-0 bg-slate-100 text-slate-600 dark:bg-navy-800 dark:text-navy-200"
        >
          <button
          ...
          >
            <a href="apps-kanban.html" class="text-center w-14">
              <div class="avatar size-12">
                <div class="text-white rounded-full is-initial bg-success">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5"
                    fill="none"
            ...
            <a href="dashboards-crm-analytics.html" class="text-center w-14">
              <div class="avatar size-12">
                <div class="text-white rounded-full is-initial bg-secondary">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5"
                    fill="none"
            ...
            <a href="apps-filemanager.html" class="text-center w-14">
              <div class="avatar size-12">
                <div class="text-white rounded-full is-initial bg-error">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5"
                    fill="none"
            ...
            <a href="dashboards-crypto-1.html" class="text-center w-14">
              <div class="avatar size-12">
                <div class="text-white rounded-full is-initial bg-secondary">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="dashboards-banking-1.html" class="text-center w-14">
              <div class="avatar size-12">
                <div
            ...
            <a href="dashboards-orders.html" class="text-center w-14">
              <div class="avatar size-12">
