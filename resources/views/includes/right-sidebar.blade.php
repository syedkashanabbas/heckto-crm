        ...
        <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
          ...
          >
            <div class="flex items-center justify-between px-4 py-2">
              ...
              <button
                @click="$store.global.isRightSidebarExpanded=false"
                class="p-0 -mr-1 rounded-full btn size-6 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="size-4"
            ...
            >
              <label class="relative flex px-3">
                <input
                  class="w-full h-8 px-3 py-2 rounded-lg form-input peer bg-slate-150 pl-9 text-xs-plus ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring-3 dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
              ...
              <div class="mt-3">
                <h2
                  class="px-3 font-medium tracking-wide text-xs-plus text-slate-700 line-clamp-1 dark:text-navy-100"
                >
                  Banking cards
                </h2>
                <div
                  class="px-3 mt-3 swiper"
                ...
                >
                  <div class="swiper-wrapper">
                    ...
                    >
                      ...
                      <div
                        class="absolute bottom-0 right-0 -m-3 mask is-diamond size-16 bg-white/20"
                      ></div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div
                        class="absolute top-0 right-0 -m-3 mask is-hexagon-2 size-16 bg-white/20"
                      ></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="px-3 mt-4">
                <h2
                  class="font-medium tracking-wide text-xs-plus text-slate-700 line-clamp-1 dark:text-navy-100"
                >
                  Pinned Apps
                </h2>
                <div class="flex mt-3 space-x-3">
                  <a href="apps-kanban.html" class="w-12 text-center">
                    <div class="avatar size-10">
                      <div
                        class="text-white is-initial mask is-squircle bg-success"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="size-5"
                  ...
                  >
                    <div class="avatar size-10">
                      <div
                        class="text-white is-initial mask is-squircle bg-warning"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="size-5"
                  ...
                  <a href="apps-chat.html" class="w-12 text-center">
                    <div class="avatar size-10">
                      <div
                        class="text-white is-initial mask is-squircle bg-info"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="size-5"
                  ...
                  <a href="apps-filemanager.html" class="w-12 text-center">
                    <div class="avatar size-10">
                      <div
                        class="text-white is-initial mask is-squircle bg-error"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="size-5"
                  ...
                  <a href="dashboards-banking-1.html" class="w-12 text-center">
                    <div class="avatar size-10">
                      <div
                        class="text-white is-initial mask is-squircle bg-secondary"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="size-5"
                  ...
                  >
                    <div class="flex flex-col justify-between flex-1">
                      ...
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex">
                          <button
                            class="p-0 rounded-full btn h-7 w-7 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="size-4"
                    ...
                    <img
                      ...
                      class="object-cover object-center rounded-lg size-20"
                      alt="image"
                    />
                  </div>
              ...
              <div class="px-3 mt-3">
                <div class="p-3 rounded-lg bg-slate-100 dark:bg-navy-600">
                  <div class="flex items-center justify-between">
                    ...
                    <a
                      href="pages-starter-3.html#"
                      class="font-medium transition-colors duration-300 text-xs-plus text-primary outline-hidden hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70"
                      >Upgrade</a
                    >
                  </div>
            ...
            >
              ...
              <div
                class="p-3 mt-4 border rounded-lg border-slate-150 dark:border-navy-600"
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="object-cover object-center rounded-lg size-10"
                ...
                <div class="mt-4">
                  ...
                  <p
                    class="mt-2 font-medium text-right text-xs-plus text-primary dark:text-accent-light"
                  >
                    25%
                  </p>
                </div>
                ...
                <div class="flex items-center justify-between mt-3 space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <div
                        class="text-white uppercase rounded-full is-initial bg-info text-xs-plus ring-2 ring-white dark:ring-navy-700"
                      >
                        jd
                      </div>
                    </div>
                  ...
                  <button
                    class="p-0 font-medium rounded-full btn h-7 w-7 bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <div class="flex items-center justify-between mt-3 space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <div
                        class="text-white uppercase rounded-full is-initial bg-warning text-xs-plus ring-2 ring-white dark:ring-navy-700"
                      >
                        dv
                      </div>
                    </div>
              ...
              >
                ...
                <div class="flex items-center justify-between mt-3 space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <div
                        class="text-white uppercase rounded-full is-initial bg-error text-xs-plus ring-2 ring-white dark:ring-navy-700"
                      >
                        gt
                      </div>
                    </div>
              ...
              >
                ...
                <div class="flex items-center justify-between mt-3 space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <div
                        class="text-white uppercase rounded-full is-initial bg-success text-xs-plus ring-2 ring-white dark:ring-navy-700"
                      >
                        jd
                      </div>
                    </div>
            ...
            >
              <div
                class="flex flex-col items-center px-8 py-3 mx-3 rounded-lg bg-slate-100 dark:bg-navy-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                  class="h-2 mt-3 progress bg-secondary/15 dark:bg-secondary-light/25"
                >
                  <div
                    class="relative w-8/12 overflow-hidden rounded-full is-active bg-secondary dark:bg-secondary-light"
                  ></div>
                ...
                <button
                  class="px-3 mt-5 space-x-2 font-medium border rounded-full btn border-slate-300 text-xs-plus text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <ol class="timeline line-space mt-5 px-4 [--size:1.5rem]">
                <li class="timeline-item">
                  <div
                    class="bg-white border border-current rounded-full timeline-item-point text-secondary dark:bg-navy-700 dark:text-secondary-light"
                  >
                    <i class="fa fa-user-edit text-tiny"></i>
                  </div>
                  <div class="flex-1 pl-4 timeline-item-content">
                    <div
                ...
                <li class="timeline-item">
                  <div
                    class="bg-white border border-current rounded-full timeline-item-point text-primary dark:bg-navy-700 dark:text-accent"
                  >
                ...
                <li class="timeline-item">
                  <div
                    class="bg-white border border-current rounded-full timeline-item-point text-success dark:bg-navy-700"
                  >
                  ...
                  <div class="flex-1 pl-4 timeline-item-content">
                    ...
                    <a
                      href="pages-starter-3.html#"
                      class="inline-flex items-center pt-2 space-x-1 transition-colors text-slate-600 hover:text-primary dark:text-navy-100 dark:hover:text-accent"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="size-5"
                    ...
                    <div class="pt-2">
                      <a
                        href="pages-starter-3.html#"
                        class="border rounded-full tag border-secondary/30 bg-secondary/10 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25 dark:border-secondary-light/30 dark:bg-secondary-light/10 dark:text-secondary-light dark:hover:bg-secondary-light/20 dark:focus:bg-secondary-light/20 dark:active:bg-secondary-light/25"
                      >
                        UI/UX
                      </a>
                      ...
                      <a
                        href="pages-starter-3.html#"
                        class="border rounded-full tag border-info/30 bg-info/10 text-info hover:bg-info/20 focus:bg-info/20 active:bg-info/25"
                      >
                        CRM
                      </a>
                      ...
                      <a
                        href="pages-starter-3.html#"
                        class="border rounded-full tag border-success/30 bg-success/10 text-success hover:bg-success/20 focus:bg-success/20 active:bg-success/25"
                      >
                        Dashboard
                      </a>
                    </div>
                ...
                <li class="timeline-item">
                  <div
                    class="bg-white border border-current rounded-full timeline-item-point text-warning dark:bg-navy-700"
                  >
                ...
                <li class="timeline-item">
                  <div
                    class="bg-white border border-current rounded-full timeline-item-point text-error dark:bg-navy-700"
                  >
            ...
            <div
              class="absolute flex justify-center w-full pointer-events-none bottom-4"
            >
              <div
